...
if (current_user_can('manage_options')) {
    ...
    // get post data
    $prefix = isset($post_data['prefix']) ? (sanitize_text_field($post_data['prefix'])) : '';
    ...
    $coupon_type = isset($post_data['coupon_type']) && !empty($post_data['coupon_type']) ? (sanitize_text_field($post_data['coupon_type'])) : 'char';
