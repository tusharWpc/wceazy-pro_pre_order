...
<div id="wceazy_address_book">
    ...
    <div class="wceazy_address_book_page_title">
        ...
        <div class="page_title_part_right">
            <button class="wceazy_address_book_back_to_dashboard_btn" onclick="wceazy_modules_page_init(`<?php echo esc_url(WCEAZY_PRO_URL); ?>`)"><?php esc_html_e('Back to all Modules','wceazy' ); ?></button>
        </div>
    </div>
    ...
    <div class="wceazy_address_book_container">
        ...
        <div class="wceazy_address_book_tab">
            ...
            <div class="coupon_data_tabs">
                ...
                <div class="tab_item" data-target="tab_styles"><h1><?php esc_html_e('Styles', 'wceazy'); ?></h1></div>
            </div>
                ...
                <div class="coupon_tab_body" data-id="tab_typography">
                    ...
                    <div class="tab_body_form">
                        ...
                        <div class="wceazy_address_book_field_group wceazy_address_book_billing_add_btn_text">
                            <label for="coupon_generator_coupon_amount"><?php esc_html_e('Add Billing Address Button Text','wceazy' ); ?></label>
                            <div class="field_with_msg_container">
                                <input class="wceazy_address_book_text_field" type="text" placeholder="" value="<?php echo esc_attr($wceazy_ab_billing_add_btn_text); ?>">
                        ...
                        <div class="wceazy_address_book_field_group wceazy_address_book_shipping_add_btn_text">
                            <label for="coupon_generator_coupon_amount"><?php esc_html_e('Add Shipping Address Button Text','wceazy' ); ?></label>
                            <div class="field_with_msg_container">
                                <input class="wceazy_address_book_text_field" type="text" placeholder="" value="<?php echo esc_attr($wceazy_ab_shipping_add_btn_text); ?>">
                        ...
                        <div class="wceazy_address_book_field_group wceazy_address_book_billing_empty_text">
                            <label for="coupon_generator_coupon_amount"><?php esc_html_e('Billing Address Book Empty Message','wceazy' ); ?></label>
                            <div class="field_with_msg_container">
                                <input class="wceazy_address_book_text_field" type="text" placeholder="" value="<?php echo esc_attr($wceazy_ab_billing_empty_text); ?>">
                        ...
                        <div class="wceazy_address_book_field_group wceazy_address_book_shipping_empty_text">
                            <label for="coupon_generator_coupon_amount"><?php esc_html_e('Shipping Address Book Empty Message','wceazy' ); ?></label>
                            <div class="field_with_msg_container">
                                <input class="wceazy_address_book_text_field" type="text" placeholder="" value="<?php echo esc_attr($wceazy_ab_shipping_empty_text); ?>">
                        ...
                        <div class="wceazy_address_book_field_group wceazy_address_book_edit_text">
                            <label for="coupon_generator_coupon_amount"><?php esc_html_e('Address Edit Link Text','wceazy' ); ?></label>
                            <div class="field_with_msg_container">
                                <input class="wceazy_address_book_text_field" type="text" placeholder="" value="<?php echo esc_attr($wceazy_ab_edit_text); ?>">
                        ...
                        <div class="wceazy_address_book_field_group wceazy_address_book_delete_text">
                            <label for="coupon_generator_coupon_amount"><?php esc_html_e('Address Delete Link Text','wceazy' ); ?></label>
                            <div class="field_with_msg_container">
                                <input class="wceazy_address_book_text_field" type="text" placeholder="" value="<?php echo esc_attr($wceazy_ab_delete_text); ?>">
                        ...
                        <div class="wceazy_address_book_field_group wceazy_address_book_make_primary_text">
                            <label for="coupon_generator_coupon_amount"><?php esc_html_e('Address Make Primary Link Text','wceazy' ); ?></label>
                            <div class="field_with_msg_container">
                                <input class="wceazy_address_book_text_field" type="text" placeholder="" value="<?php echo esc_attr($wceazy_ab_make_primary_text); ?>">
                ...
                <div class="coupon_tab_body" data-id="tab_styles">
                    ...
                    <div class="tab_body_form"> 
                        <div class="wceazy_address_book_field_group wceazy_address_book_add_btn_bg_color">
                            <label for="coupon_generator_coupon_amount"><?php esc_html_e('Add Button Background Color','wceazy' ); ?></label>
                            <div class="field_with_msg_container">
                                <div class="color_picker_area">
                                    <input type="color" id="wceazy_address_book_add_btn_bg_color" value="<?php echo esc_attr($wceazy_ab_add_btn_bg_color); ?>">
                        ...
                        <div class="wceazy_address_book_field_group wceazy_address_book_add_btn_text_color">
                            <label for="coupon_generator_coupon_amount"><?php esc_html_e('Add Button Text Color','wceazy' ); ?></label>
                            <div class="field_with_msg_container">
                                <div class="color_picker_area">
                                    <input type="color" id="wceazy_address_book_add_btn_text_color" value="<?php echo esc_attr($wceazy_ab_add_btn_text_color); ?>">
                        ...
                        <div class="wceazy_address_book_field_group wceazy_address_book_add_btn_bg_hover_color">
                            <label for="coupon_generator_coupon_amount"><?php esc_html_e('Add Button Background Hover Color','wceazy' ); ?></label>
                            <div class="field_with_msg_container">
                                <div class="color_picker_area">
                                    <input type="color" id="wceazy_address_book_add_btn_bg_hover_color" value="<?php echo esc_attr($wceazy_ab_add_btn_bg_hover_color); ?>">
                        ...
                        <div class="wceazy_address_book_field_group wceazy_address_book_add_btn_text_hover_color">
                            <label for="coupon_generator_coupon_amount"><?php esc_html_e('Add Button Text Hover Color','wceazy' ); ?></label>
                            <div class="field_with_msg_container">
                                <div class="color_picker_area">
                                    <input type="color" id="wceazy_address_book_add_btn_text_hover_color" value="<?php echo esc_attr($wceazy_ab_add_btn_text_hover_color); ?>">
                        ...
                        <div class="wceazy_address_book_field_group wceazy_address_book_add_btn_border_hover_color">
                            <label for="coupon_generator_coupon_amount"><?php esc_html_e('Add Button Border Hover Color','wceazy' ); ?></label>
                            <div class="field_with_msg_container">
                                <div class="color_picker_area">
                                    <input type="color" id="wceazy_address_book_add_btn_border_hover_color" value="<?php echo esc_attr($wceazy_ab_add_btn_border_hover_color); ?>">
                        ...
                        <div class="wceazy_address_book_field_group wceazy_address_book_card_bg_color">
                            <label for="coupon_generator_coupon_amount"><?php esc_html_e('Address Card Background Color','wceazy' ); ?></label>
                            <div class="field_with_msg_container">
                                <div class="color_picker_area">
                                    <input type="color" id="wceazy_address_book_card_bg_color" value="<?php echo esc_attr($wceazy_ab_card_bg_color); ?>">
                        ...
                        <div class="wceazy_address_book_field_group wceazy_address_book_card_border_color">
                            <label for="coupon_generator_coupon_amount"><?php esc_html_e('Address Card Border Color','wceazy' ); ?></label>
                            <div class="field_with_msg_container">
                                <div class="color_picker_area">
                                    <input type="color" id="wceazy_address_book_card_border_color" value="<?php echo esc_attr($wceazy_ab_card_border_color); ?>">
                        ...
                        <div class="wceazy_address_book_field_group wceazy_address_book_card_text_color">
                            <label for="coupon_generator_coupon_amount"><?php esc_html_e('Address Text Color','wceazy' ); ?></label>
                            <div class="field_with_msg_container">
                                <div class="color_picker_area">
                                    <input type="color" id="wceazy_address_book_card_text_color" value="<?php echo esc_attr($wceazy_ab_card_text_color); ?>">
                        ...
                        <div class="wceazy_address_book_field_group wceazy_address_book_card_footer_color">
                            <label for="coupon_generator_coupon_amount"><?php esc_html_e('Address Card Footer Background Color','wceazy' ); ?></label>
                            <div class="field_with_msg_container">
                                <div class="color_picker_area">
                                    <input type="color" id="wceazy_address_book_card_footer_color" value="<?php echo esc_attr($wceazy_ab_card_footer_color); ?>">
                        ...
                        <div class="wceazy_address_book_field_group wceazy_address_book_card_link_text_color">
                            <label for="coupon_generator_coupon_amount"><?php esc_html_e('Address Card Link Text Color','wceazy' ); ?></label>
                            <div class="field_with_msg_container">
                                <div class="color_picker_area">
                                    <input type="color" id="wceazy_address_book_card_link_text_color" value="<?php echo esc_attr($wceazy_ab_card_link_text_color); ?>">
