...
<div id="wceazy_shipping_bar">
    ...
    <div class="wceazy_shipping_bar_header">
        ...
        <div class="wceazy_header_part_right">
            <a target="_blank" href="<?php echo WCEAZY_PRO_HELP_PAGE; ?>">Need help?</a>
        </div>
    </div>
    ...
    <div class="wceazy_shipping_bar_page_title">
        <div class="page_title_part_left">
            ...
            <a target="_blank" href="<?php echo WCEAZY_PRO_DOCS_PAGE; ?>">Documentation</a>
        </div>
        <div class="page_title_part_right">
            <button class="wceazy_shipping_bar_back_to_dashboard_btn" onclick="wceazy_modules_page_init(`<?php echo esc_url(WCEAZY_PRO_URL); ?>`)">Back to all Modules</button>
        </div>
    </div>
                ...
                <div class="coupon_tab_body" data-id="tab_general">
                    ...
                    <div class="tab_body_form">
                        ...
                        <div class="wceazy_shipping_bar_field_group wceazy_shipping_bar_dont_show_pages">
                            <label for="coupon_generator_coupon_amount">Exclude Pages</label>
                            <div class="field_with_msg_container">
                        ...
                        <div class="wceazy_shipping_bar_field_group wceazy_shipping_bar_exclude_products">
                            <label for="coupon_generator_coupon_amount">Exclude Products</label>
                            <div class="field_with_msg_container">
                                <select class="wceazy_shipping_bar_select_field" multiple="multiple">
                                    <option value=""> Please select</option>
                ...
                <div class="coupon_tab_body" data-id="tab_cart_and_checkout">
                    ...
                    <div class="tab_body_form">
                        ...
                        <div class="wceazy_shipping_bar_field_group wceazy_shipping_bar_cart_checkout_progress_bar_bg">
                            <label for="coupon_generator_coupon_amount">Progress Bar's Background</label>
                            <div class="field_with_msg_container">
                                <div class="color_picker_area">
                                    <input type="color" id="wceazy_shipping_bar_cart_checkout_progress_bar_bg" value="<?php echo esc_attr($wceazy_sb_cart_checkout_progress_bar_bg); ?>">
                        ...
                        <div class="wceazy_shipping_bar_field_group wceazy_shipping_bar_cart_checkout_progress_color">
                            <label for="coupon_generator_coupon_amount">Progress Bar's Color</label>
                            <div class="field_with_msg_container">
                                <div class="color_picker_area">
                                    <input type="color" id="wceazy_shipping_bar_cart_checkout_progress_color" value="<?php echo esc_attr($wceazy_sb_cart_checkout_progress_color); ?>">
                        ...
                        <div class="wceazy_shipping_bar_field_group wceazy_shipping_bar_cart_checkout_progress_text_color">
                            <label for="coupon_generator_coupon_amount">Progress Bar's Text Color</label>
                            <div class="field_with_msg_container">
                                <div class="color_picker_area">
                                    <input type="color" id="wceazy_shipping_bar_cart_checkout_progress_text_color" value="<?php echo esc_attr($wceazy_sb_cart_checkout_progress_text_color); ?>">
                ...
                <div class="coupon_tab_body" data-id="tab_messages">
                    ...
                    <div class="tab_body_form">
                        ...
                        <div class="wceazy_shipping_bar_field_group wceazy_shipping_bar_zero_order_amount_msg">
                            <label for="coupon_generator_coupon_amount">Message on Zero Order Amount</label>
                            <div class="field_with_msg_container">
                                <textarea class="wceazy_shipping_bar_textarea_field" rows="3"><?php echo esc_attr($wceazy_sb_zero_order_amount_msg); ?></textarea>
                        ...
                        <div class="wceazy_shipping_bar_field_group wceazy_shipping_bar_partial_order_amount_msg">
                            <label for="coupon_generator_coupon_amount">Message on Partially Completed Order Amount</label>
                            <div class="field_with_msg_container">
                                <textarea class="wceazy_shipping_bar_textarea_field" rows="3"><?php echo esc_attr($wceazy_sb_partial_order_amount_msg); ?></textarea>
                        ...
                        <div class="wceazy_shipping_bar_field_group wceazy_shipping_bar_completed_order_amount_msg">
                            <label for="coupon_generator_coupon_amount">Message on Completed Order Amount</label>
                            <div class="field_with_msg_container">
                                <textarea class="wceazy_shipping_bar_textarea_field" rows="3"><?php echo esc_attr($wceazy_sb_completed_order_amount_msg); ?></textarea>
                ...
                <div class="coupon_tab_body" data-id="tab_effect">
                    ...
                    <div class="tab_body_form">
                        ...
                        <div class="wceazy_shipping_bar_field_group wceazy_shipping_bar_initial_delay">
                            <label for="coupon_generator_coupon_amount">Initial Delay Time</label>
                            <div class="field_with_msg_container">
                                <input class="wceazy_shipping_bar_text_field" type="number" placeholder="" value="<?php echo esc_attr($wceazy_sb_initial_delay); ?>">
                        ...
                        <div class="wceazy_shipping_bar_field_group wceazy_shipping_bar_allow_disappear_time">
                            <label for="coupon_generator_coupon_amount">Allow Disappear Time</label>
                            <div class="field_with_msg_container">
                                <label class="toggle_switch"><input type="checkbox" <?php echo esc_attr($wceazy_sb_allow_disappear_time == "yes" ? "checked" : ""); ?> onchange="wceazy_shipping_bar_selection_changed()"><span class="slider round"></span></label>
                        ...
                        <div class="wceazy_shipping_bar_field_group wceazy_shipping_bar_disappear_time">
                            <label for="coupon_generator_coupon_amount">Set Disappear Time</label>
                            <div class="field_with_msg_container">
                                <input class="wceazy_shipping_bar_text_field" type="number" placeholder="" value="<?php echo esc_attr($wceazy_sb_disappear_time); ?>">
                ...
                <div class="coupon_tab_body" data-id="tab_style">
                    ...
                    <div class="tab_body_form">
                        ...
                        <div class="wceazy_shipping_bar_field_group wceazy_shipping_bar_bg">
                            ...
                            <div class="field_with_msg_container">
                                <div class="color_picker_area">
                                    <input type="color" id="wceazy_shipping_bar_bg" value="<?php echo esc_attr($wceazy_sb_bg); ?>">
                        ...
                        <div class="wceazy_shipping_bar_field_group wceazy_shipping_bar_msg_text_color">
                            <label for="coupon_generator_coupon_amount">Text Color of Message</label>
                            <div class="field_with_msg_container">
                                <div class="color_picker_area">
                                    <input type="color" id="wceazy_shipping_bar_msg_text_color" value="<?php echo esc_attr($wceazy_sb_msg_text_color); ?>">
                        ...
                        <div class="wceazy_shipping_bar_field_group wceazy_shipping_bar_msg_link_text_color">
                            <label for="coupon_generator_coupon_amount">Link Color on Message</label>
                            <div class="field_with_msg_container">
                                <div class="color_picker_area">
                                    <input type="color" id="wceazy_shipping_bar_msg_link_text_color" value="<?php echo esc_attr($wceazy_sb_msg_link_text_color); ?>">
                        ...
                        <div class="wceazy_shipping_bar_field_group wceazy_shipping_bar_remove_icon_color">
                            <label for="coupon_generator_coupon_amount">Close Icon Color</label>
                            <div class="field_with_msg_container">
                                <div class="color_picker_area">
                                    <input type="color" id="wceazy_shipping_bar_remove_icon_color" value="<?php echo esc_attr($wceazy_sb_remove_icon_color); ?>">
                        ...
                        <div class="wceazy_shipping_bar_field_group wceazy_shipping_bar_progress_bar_bg">
                            ...
                            <div class="field_with_msg_container">
                                <div class="color_picker_area">
                                    <input type="color" id="wceazy_shipping_bar_progress_bar_bg" value="<?php echo esc_attr($wceazy_sb_progress_bar_bg); ?>">
                        ...
                        <div class="wceazy_shipping_bar_field_group wceazy_shipping_bar_progress_color">
                            ...
                            <div class="field_with_msg_container">
                                <div class="color_picker_area">
                                    <input type="color" id="wceazy_shipping_bar_progress_color" value="<?php echo esc_attr($wceazy_sb_progress_color); ?>">
                        ...
                        <div class="wceazy_shipping_bar_field_group wceazy_shipping_bar_progress_text_color">
                            ...
                            <div class="field_with_msg_container">
                                <div class="color_picker_area">
                                    <input type="color" id="wceazy_shipping_bar_progress_text_color" value="<?php echo esc_attr($wceazy_sb_progress_text_color); ?>">
