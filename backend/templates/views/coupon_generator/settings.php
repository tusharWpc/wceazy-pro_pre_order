<div id="wceazy_coupon_generator">
    ...
    <div class="wceazy_coupon_generator_page_title">
        ...
        <div class="page_title_part_right">
            <button class="wceazy_coupon_generator_back_to_dashboard_btn" onclick="wceazy_modules_page_init('<?php echo esc_url(WCEAZY_PRO_URL); ?>')"><?php esc_html_e('Back to all Modules', 'wceazy'); ?></button>
        </div>
    </div>
        ...
        <form class="wceazy_coupon_generator_form_for_reset_purpose">
            ...
            <div class="wceazy_coupon_generator_top_action">
                ...
                <div class="wceazy_coupon_generator_field_group_flex wceazy_coupon_generator_prefix">
                    <label><?php esc_html_e('Prefix', 'wceazy'); ?></label>
                    <input class="wceazy_coupon_generator_text_field" type="text" placeholder="<?php esc_attr_e('Coupon prefix', 'wceazy'); ?>">
                </div>
                ...
                <div class="wceazy_coupon_generator_field_group_flex wceazy_coupon_generator_coupon_type">
                    <label class="wceazy_coupon_generator_select2_label"><?php esc_html_e('Coupon Type', 'wceazy'); ?></label>
                    <select class="wceazy_coupon_generator_select_field">
                        ...
                        <option value="num"><?php esc_html_e('Numbers', 'wceazy'); ?></option>
                        <option value="charNum"><?php esc_html_e('Characters & Numbers', 'wceazy'); ?></option>
                    </select>
                </div>
            ...
            <div class="wceazy_coupon_generator_tab">
                <div class="wceazy_coupon_generator_tab_part_left">
                    <div class="coupon_data_tabs">
                        <div class="tab_item tab_item_active" data-target="coupon_tab_general"><h1><?php esc_html_e('General', 'wceazy'); ?></h1></div>
                        <div class="tab_item" data-target="coupon_tab_usage_restriction"><h1><?php esc_html_e('Usage Restriction', 'wceazy'); ?></h1></div>
                        <div class="tab_item" data-target="coupon_tab_usage_limits"><h1><?php esc_html_e('Usage Limits', 'wceazy'); ?></h1></div>
                    </div>
                </div>

                <div class="wceazy_coupon_generator_tab_part_right">
                    <div class="coupon_tab_body" data-id="coupon_tab_general">
                        <div class="tab_body_title"><h1><?php esc_html_e('General', 'wceazy'); ?></h1></div>
                        <div class="tab_body_form" id="tab_body_form">
                            ...
                            <div class="wceazy_coupon_generator_field_group wceazy_coupon_generator_free_shipping">
                                ...
                                <div class="wceazy_coupon_checkbox">
                                    ...
                                    <?php esc_html_e('must be enabled in your shipping zone and be set to require "a valid free shipping coupon" (see the "Free Shipping Requires" setting).', 'wceazy'); ?></span>
                                </div>
                            </div>
                    ...
                    <div class="coupon_tab_body" data-id="coupon_tab_usage_restriction">
                        <div class="tab_body_title"><h1><?php esc_html_e('Usage restriction', 'wceazy'); ?></h1></div>
                        <div class="tab_body_form" id="tab_body_form">
                    ...
                    <div class="coupon_tab_body" data-id="coupon_tab_usage_limits">
                        <div class="tab_body_title"><h1><?php esc_html_e('Usage limits', 'wceazy'); ?></h1></div>
                        <div class="tab_body_form" id="tab_body_form">
    ...
    <div class="wceazy_coupon_generator_bottom_button_section">
            <button onclick="wceazy_submit_coupon_generator();"><?php esc_html_e('Generate Coupons', 'wceazy'); ?></button>
        </div>
    </div>
</div>
...
<div class="wceazy_coupon_generator_popup">
    <div class="wceazy_coupon_generator_popup_inner">
        <div class="generating_coupon">
            ...
            <img src="<?php echo esc_url(WCEAZY_PRO_IMG_DIR . 'modules/coupon_generator/popup_spinner.svg'); ?>" alt="">
        </div>
