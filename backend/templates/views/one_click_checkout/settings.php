...
<div class="wceazy_one_click_checkout_header">
    <div class="wceazy_header_part_left">
        <p><?php echo esc_html__('wceazy', 'wceazy'); ?> <span><?php echo esc_attr(WCEAZY_VERSION); ?></span></p>
    </div>
    <div class="wceazy_header_part_right">
        <a class="wceazy_get_pro" target="_blank" href="<?php echo esc_url(WCEAZY_GET_PRO_URL); ?>"><?php echo esc_html__('Need help?' , 'wceazy'); ?></a>
    </div>
</div>
...
<div class="wceazy_one_click_checkout_page_title">
        ...
        <div class="page_title_part_right">
            <button class="wceazy_one_click_checkout_back_to_dashboard_btn" onclick="wceazy_modules_page_init(`<?php echo esc_url(WCEAZY_URL); ?>`)"><?php esc_html_e('Back to all Modules', 'wceazy'); ?></button>
        </div>
    </div> 
        ...
        <div class="wceazy_one_click_checkout_tab">
            ...
            <div class="wceazy_one_click_checkout_tab_part_right">
                ...
                <div class="coupon_tab_body" data-id="tab_general">
                    ...
                    <div class="tab_body_form"> 
                        <div class="wceazy_one_click_checkout_field_group wceazy_one_click_checkout_disable_cart">
                            <label for="coupon_generator_coupon_amount"><?php esc_html_e('Disable Cart Page', 'wceazy'); ?></label>
                            <div class="field_with_msg_container">
                                ...
                                <small><?php esc_html_e('Disable the cart page. It will automatically redirect to the checkout page.', 'wceazy'); ?></small>
                            </div>
                        </div>
                        ...
                        <div class="wceazy_one_click_checkout_field_group wceazy_one_click_checkout_enable_redirect_to_cart">
                            <label for="coupon_generator_coupon_amount"><?php esc_html_e('Enable Redirect on Add to Cart', 'wceazy'); ?></label>
                            <div class="field_with_msg_container">
                                ...
                                <small><?php esc_html_e('After clicking the add to cart button, it will automatically redirect to the checkout page.', 'wceazy'); ?></small>
                            </div>
                        </div>
                ...
                <div class="coupon_tab_body" data-id="tab_add_to_cart">
                    ...
                    <div class="tab_body_form">
                        ...
                        <div class="wceazy_one_click_checkout_field_group wceazy_one_click_checkout_enable_product_ajax_to_cart">
                            <label for="coupon_generator_coupon_amount"><?php esc_html_e('Ajax add to cart on single product', 'wceazy'); ?></label>
                            <div class="field_with_msg_container">
                                <label class="toggle_switch"><input type="checkbox" <?php echo esc_attr($wceazy_occ_enable_product_ajax_to_cart == "yes" ? "checked" : ""); ?>><span class="slider round"></span></label>
                ...
                <div class="coupon_tab_body" data-id="tab_buy_now_button">
                    ...
                    <div class="tab_body_form"> 
                        <h4><?php esc_html_e('Buy Now Button  Product Page', 'wceazy'); ?></h4>

                        <div class="wceazy_one_click_checkout_field_group wceazy_one_click_checkout_enable_buy_now_button_on_product">
                            <label for="coupon_generator_coupon_amount"><?php esc_html_e('Enable Buy Now Button', 'wceazy'); ?></label>
                            <div class="field_with_msg_container">
                                ...
                                <small><?php esc_html_e('Turn on if you want Buy Now button on product page.', 'wceazy'); ?></small>
                            </div>
                        </div>

                        <div class="wceazy_one_click_checkout_field_group wceazy_one_click_checkout_buy_btn_label_on_product">
                            <label for="coupon_generator_coupon_amount"><?php esc_html_e('Buy now button label', 'wceazy'); ?></label>
                            <div class="field_with_msg_container">
                                <input class="wceazy_one_click_checkout_text_field" type="text" placeholder="" value="<?php echo esc_attr($wceazy_occ_buy_btn_label_on_product); ?>">
                        ...
                        <div class="wceazy_one_click_checkout_field_group wceazy_one_click_checkout_buy_btn_position_on_product">
                            <label for="coupon_generator_coupon_amount"><?php esc_html_e('Position Of the Button', 'wceazy'); ?></label>
                            <div class="field_with_msg_container">
                                <select class="wceazy_one_click_checkout_select_field">
                                    <option value=""> <?php esc_html_e('Please select', 'wceazy'); ?></option>
                        ...
                        <h4><?php esc_html_e(' Buy Now Button on the Archive Page', 'wceazy'); ?></h4>
                        ...
                        <div class="wceazy_one_click_checkout_field_group wceazy_one_click_checkout_enable_buy_now_button_on_product_archive">
                            ...
                            <div class="field_with_msg_container">
                                ...
                                <small><?php esc_html_e(' Turn on if you want Buy Now button on product archive page.', 'wceazy'); ?></small>
                            </div>
                        </div>
                        ...
                        <div class="wceazy_one_click_checkout_field_group wceazy_one_click_checkout_buy_btn_label_on_product_archive">
                            <label for="coupon_generator_coupon_amount"><?php esc_html_e(' Buy now button label', 'wceazy'); ?></label>
                            <div class="field_with_msg_container">
                                <input class="wceazy_one_click_checkout_text_field" type="text" placeholder="" value="<?php echo esc_attr($wceazy_occ_buy_btn_label_on_product_archive); ?>">
                                <small><?php esc_html_e(' Buy now button label', 'wceazy'); ?></small>
                            </div>
                        </div>
                        ...
                        <div class="wceazy_one_click_checkout_field_group wceazy_one_click_checkout_buy_btn_position_on_product_archive">
                            ...
                            <div class="field_with_msg_container">
                                <select class="wceazy_one_click_checkout_select_field">
                                    <option value=""> <?php esc_html_e(' Please select', 'wceazy'); ?></option>
                                    <option value="before_button" <?php echo esc_attr("before_button" == $wceazy_occ_buy_btn_position_on_product_archive ? "selected" : ""); ?>><?php esc_html_e('  Before add to cart button ', 'wceazy'); ?></option>
                                    <option value="after_button" <?php echo esc_attr("after_button" == $wceazy_occ_buy_btn_position_on_product_archive ? "selected" : ""); ?>> <?php esc_html_e(' After add to cart button', 'wceazy'); ?> </option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="wceazy_one_click_checkout_field_group wceazy_one_click_checkout_buy_now_btn_hover_color">
                            <label for="coupon_generator_coupon_amount"><?php esc_html_e(' Hover Font Color', 'wceazy'); ?></label>
                            <div class="field_with_msg_container">
                                <div class="color_picker_area">
                                    <input type="color" id="wceazy_one_click_checkout_buy_now_btn_hover_color" value="<?php echo esc_attr($wceazy_occ_buy_now_btn_hover_color); ?>">
                        ...
                        <div class="wceazy_one_click_checkout_field_group wceazy_one_click_checkout_buy_now_btn_hover_bg_color">
                            <label for="coupon_generator_coupon_amount"><?php esc_html_e(' Hover Background Color', 'wceazy'); ?></label>
                            <div class="field_with_msg_container">
                                <div class="color_picker_area">
                                    <input type="color" id="wceazy_one_click_checkout_buy_now_btn_hover_bg_color" value="<?php echo esc_attr($wceazy_occ_buy_now_btn_hover_bg_color); ?>">
                        ...
                        <div class="wceazy_one_click_checkout_field_group wceazy_one_click_checkout_buy_now_btn_ptpb">
                            <label for="coupon_generator_coupon_amount"><?php esc_html_e(' Padding Top-Bottom', 'wceazy'); ?></label>
                            <div class="field_with_msg_container">
                                <input class="wceazy_one_click_checkout_text_field" type="number" placeholder="" value="<?php echo esc_attr($wceazy_occ_buy_now_btn_ptpb); ?>">
                        ...
                        <div class="wceazy_one_click_checkout_field_group wceazy_one_click_checkout_buy_now_btn_plpr">
                            ...
                            <div class="field_with_msg_container">
                                <input class="wceazy_one_click_checkout_text_field" type="number" placeholder="" value="<?php echo esc_attr($wceazy_occ_buy_now_btn_plpr); ?>">
                        ...
                        <div class="wceazy_one_click_checkout_field_group wceazy_one_click_checkout_buy_now_btn_border_radius">
                            <label for="coupon_generator_coupon_amount"><?php esc_html_e(' Border Radius', 'wceazy'); ?></label>
                            <div class="field_with_msg_container">
                                <input class="wceazy_one_click_checkout_text_field" type="number" placeholder="" value="<?php echo esc_attr($wceazy_occ_buy_now_btn_border_radius); ?>">
                    ...
                    <div class="tab_body_form">
                        ...
                        <div class="wceazy_one_click_checkout_field_group wceazy_one_click_checkout_remove_order_comment">
                            ...
                            <div class="field_with_msg_container">
                                ...
                                <small><?php esc_html_e('Enable to remove “order comment” from the checkout page.', 'wceazy'); ?></small>
                            </div>
                        </div>
                        ...
                        <div class="wceazy_one_click_checkout_field_group wceazy_one_click_checkout_remove_coupon_form">
                            ...
                            <div class="field_with_msg_container">
                                ...
                                <small><?php esc_html_e('Enable to remove “Coupon Form” from the checkout page.', 'wceazy'); ?></small>
                            </div>
                        </div>

                        <div class="wceazy_one_click_checkout_field_group wceazy_one_click_checkout_remove_policy_text">
                            <label for="coupon_generator_coupon_amount"><?php esc_html_e('Remove policy text', 'wceazy'); ?></label>
                            <div class="field_with_msg_container">
                                <label class="toggle_switch"><input type="checkbox" <?php echo esc_attr($wceazy_occ_remove_policy_text == "yes" ? "checked" : ""); ?>><span class="slider round"></span></label>
                                <small><?php esc_html_e('Enable to remove “Policy Text” from the checkout page.', 'wceazy'); ?></small>
                            </div>
                        </div>

                        <div class="wceazy_one_click_checkout_field_group wceazy_one_click_checkout_remove_terms_condition">
                            <label for="coupon_generator_coupon_amount"><?php esc_html_e('Remove terms & condition?', 'wceazy'); ?></label>
                            <div class="field_with_msg_container">
                                <label class="toggle_switch"><input type="checkbox" <?php echo esc_attr($wceazy_occ_remove_terms_condition == "yes" ? "checked" : ""); ?>><span class="slider round"></span></label>
                                <small><?php esc_html_e('Enable to remove “Terms & Conditions” from the checkout page.', 'wceazy'); ?></small>
                            </div>
                        </div>


                        <div class="wceazy_one_click_checkout_field_group wceazy_one_click_checkout_remove_billing_fields">
                            <label for="coupon_generator_coupon_amount"><?php esc_html_e('Remove billing fields?', 'wceazy'); ?></label>
                            <div class="field_with_msg_container">
                                <select class="wceazy_one_click_checkout_select_field" multiple="multiple">
                                    <option value=""> <?php esc_html_e('Please select', 'wceazy'); ?></option>
                        ...
                        <div class="wceazy_one_click_checkout_field_group wceazy_one_click_checkout_remove_shipping_fields">
                            <label for="coupon_generator_coupon_amount"><?php esc_html_e('Remove shipping fields?', 'wceazy'); ?></label>
                            <div class="field_with_msg_container">
                                <select class="wceazy_one_click_checkout_select_field" multiple="multiple">
                                    ...
                                    <option value="shipping_state" <?php echo esc_attr(in_array("shipping_state", $wceazy_occ_remove_shipping_fields) ? "selected" : ""); ?>><?php esc_html__(' Shipping State ', 'wceazy'); ?></option>
                                    <option value="shipping_postcode" <?php echo esc_attr(in_array("shipping_postcode", $wceazy_occ_remove_shipping_fields) ? "selected" : ""); ?>><?php esc_html__(' Shipping Postcode ', 'wceazy'); ?></option>
                                    <option value="shipping_company" <?php echo esc_attr(in_array("shipping_company", $wceazy_occ_remove_shipping_fields) ? "selected" : ""); ?>><?php esc_html__(' Shipping Company ', 'wceazy'); ?></option>
                                </select>
                                <small><?php esc_html_e('Select the fields that you want to remove from ‘Shipping Section’.', 'wceazy'); ?></small>
                            </div>
                        </div> 
