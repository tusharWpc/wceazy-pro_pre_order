<div id="wceazy_bogo_deal">
    ...
    <div class="wceazy_bogo_deal_page_title">
        ...
        <div class="page_title_part_right">
            <button class="wceazy_bogo_deal_back_to_dashboard_btn" onclick="wceazy_modules_page_init('<?php echo esc_url(WCEAZY_PRO_URL); ?>')"><?php esc_html_e('Back to all Modules', 'wceazy'); ?></button>
    ...
    <div class="wceazy_bogo_deal_single_rule">
        <div class="wceazy_bogo_deal_intro">
            ...
            <div class="wceazy_bogo_deal_actions">
                <div class="wceazy_bogo_deal_action_minimize" onclick="wceazy_bogo_deal_rule_minimize(this)">
                    <img src="<?php echo esc_url(WCEAZY_PRO_IMG_DIR . "/modules/bogo_deal/bogo_deal_minimize.svg"); ?>">
                </div>
                <div class="wceazy_bogo_deal_action_maximize" onclick="wceazy_bogo_deal_rule_maximize(this)">
                    <img src="<?php echo esc_url(WCEAZY_PRO_IMG_DIR . "/modules/bogo_deal/bogo_deal_maximize.svg"); ?>">
                </div>
                <div class="wceazy_bogo_deal_action_del" onclick="wceazy_bogo_deal_rule_remover(this)">
                    <img src="<?php echo esc_url(WCEAZY_PRO_IMG_DIR . "/modules/bogo_deal/bogo_deal_rule_del.svg"); ?>">
        ...
        <div class="wceazy_bogo_deal_top_form">
            ...
            <div class="wceazy_form_group">
                ...
                <input placeholder="<?php esc_attr_e('Discount Amount', 'wceazy'); ?>" type="number">
            </div>
        </div>
        ...
        <div class="wceazy_bogo_deal_data_picker">
            ...
            <div class="wceazy_bogo_deal_data_contents">
                ...
                <div class="wceazy_bogo_deal_data_add_more">
                    <img onclick="wceazy_bogo_deal_product_buy_adder(this)" src="<?php echo esc_url(WCEAZY_PRO_IMG_DIR . "/modules/bogo_deal/add_icon.svg"); ?>">
                </div>
            </div>
        </div>
        ...
        <div class="wceazy_bogo_deal_data_picker">
            ...
            <div class="wceazy_bogo_deal_data_contents">
                ...
                <div class="wceazy_bogo_deal_data_add_more">
                    <img onclick="wceazy_bogo_deal_product_get_adder(this)" src="<?php echo esc_url(WCEAZY_PRO_IMG_DIR . "/modules/bogo_deal/add_icon.svg"); ?>">
                </div>
            </div>
        </div>
    </div>
...
<div id="wceazy_bogo_deal_block_product_buy_row" style="display: none;">
    <div class="wceazy_bogo_deal_product_selection_row">
        ...
        <div class="wceazy_form_group">
            ...
            <input placeholder="<?php esc_attr_e('Quantity Required', 'wceazy'); ?>" type="number">
        </div>
        <div class="wceazy_remove_field">
            <img onclick="wceazy_bogo_deal_product_removal(this)" src="<?php echo esc_url(WCEAZY_PRO_IMG_DIR . "/modules/bogo_deal/remove_product.svg"); ?>">
        </div>
    </div>
</div>
