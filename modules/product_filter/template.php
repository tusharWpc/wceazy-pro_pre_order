...
$wceazy_pf_price_filter_label_text = isset($wceazy_pf_settings["price_filter_label_text"]) ? $wceazy_pf_settings["price_filter_label_text"] : __("Filter By Price", "wceazy");
...
// $wceazy_pf_rating_filter_label_text =
// isset($wceazy_pf_settings["price_filter_label_text"]) ? $wceazy_pf_settings["price_filter_label_text"] : __("Filter By Price", "wceazy");
...
// $wceazy_pf_rating_filter_label_text = esc_html__("Filter By Rating", "wceazy");

// $wceazy_pf_category_filter_label_text = esc_html__("Filter By Category", "wceazy");
    ...
    <div id="wceazy_pf_main_<?php echo esc_attr($unique_id); ?>"
        ...
        <div class="wceazy_pf_sidebar">
            ...
            <div class="wceazy_pf_search_filter">
                ...
                <input type="text" placeholder="<?php echo esc_html($wceazy_pf_search_filter_placeholder_text); ?>"
            ...
            <div class="wceazy_pf_rating_filter">
                <label><?php echo esc_html__($wceazy_pf_rating_filter_label_text, 'wceazy'); ?></label>
            ...
            <div class="wceazy_pf_category_filter">
                <label><?php echo esc_html__($wceazy_pf_category_filter_label_text, 'wceazy'); ?></label>
                <div class="wceazy_pf_category_filter_checkbox_container">
                    ...
                    <label class="wceazy_pf_category_filter_checkbox_item"
                        data-slug="<?php echo esc_attr($category["slug"]); ?>"><?php echo esc_attr($category["title"]); ?><input
                            type="checkbox" onchange="wceazy_frontend_pf_search()"><span
            ...
            <div class="wceazy_pf_stock_filter">
                <!-- <label><?php echo $wceazy_pf_stock_filter_label_text; ?></label> -->
                <label><?php echo esc_html__($wceazy_pf_stock_filter_label_text, 'wceazy'); ?></label>
                <?php
                ...
                <div class="wceazy_pf_stock_filter_checkbox_container">
                    <label class="wceazy_pf_stock_filter_checkbox_item"
                        data-slug="instock"><?php echo $wceazy_pf_stock_filter_in_stock_text; ?><input type="checkbox"
                            onchange="wceazy_frontend_pf_search()"><span class="checkmark"></span></label>
                    <label class="wceazy_pf_stock_filter_checkbox_item"
                        data-slug="outofstock"><?php echo $wceazy_pf_stock_filter_out_stock_text; ?><input
                            type="checkbox" onchange="wceazy_frontend_pf_search()"><span
                            class="checkmark"></span></label>
                </div>
            </div>
