...
function wceazy_auto_apply_coupon_bulk_edit() {
    var wfaabc_toggole_type = jQuery('.wceazy_auto_apply_coupon_bulk_action_type').val();
    var selectedItems = [];
    jQuery('.wceazy_auto_apply_coupon_popup').addClass('opened');
    jQuery('.wceazy_auto_apply_coupon_popup .wceazy-popup-content').text('Do you want to '+wfaabc_toggole_type+' selected coupons to Auto Apply list ?');

    jQuery('[name="wceazy_auto_apply_coupon_table_row_checkboxes[]"]:checked').each(function () {
    ...
    if( selectedItems.length > 0 ){
        ...
        jQuery( ".wceazy_auto_apply_coupon_popup .wceazy-btn-success" ).bind( "click", function() {
            let post_data = {'action': 'wceazy_auto_apply_coupon_bulk_edit', 'data': couponData};
            jQuery.ajax({
            ...
            jQuery('.wceazy_auto_apply_coupon_bulk_action_type').val("");
            wceazy_auto_apply_coupon_bulk_edit_check_ability()
        });
