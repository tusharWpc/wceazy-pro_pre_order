...
if (!class_exists('WcEazyClientAjax')) {
    class WcEazyClientAjax
    {
        ...
        {
            include_once WCEAZY_PRO_PATH . "frontend/api/product_sticky_bar/add_to_cart.php";
            wp_die();
        }
        ...
        {
            include_once WCEAZY_PRO_PATH . "frontend/api/one_click_checkout/ajax_add_to_cart.php";
            wp_die();
        }
        ...
        {
            include_once WCEAZY_PRO_PATH . "frontend/api/floating_cart/get_cart.php";
            wp_die();
        }
        public function wceazy_floating_cart_remove_cart_item()
        {
            include_once WCEAZY_PRO_PATH . "frontend/api/floating_cart/remove_cart_item.php";
            wp_die();
        }
        public function wceazy_floating_cart_update_quantity()
        {
            include_once WCEAZY_PRO_PATH . "frontend/api/floating_cart/update_quantity.php";
            wp_die();
        }
        public function wceazy_floating_cart_apply_coupon()
        {
            include_once WCEAZY_PRO_PATH . "frontend/api/floating_cart/apply_coupon.php";
            wp_die();
        }
        ...
        {
            include_once WCEAZY_PRO_PATH . "frontend/api/shipping_bar/get_updated_content.php";
            wp_die();
        }
        ...
        {
            include_once WCEAZY_PRO_PATH . "frontend/api/address_book/delete.php";
            wp_die();
        }
        public function wceazy_address_book_make_primary()
        {
            include_once WCEAZY_PRO_PATH . "frontend/api/address_book/make_primary.php";
            wp_die();
        }
        public function wceazy_address_book_get_address_on_checkout()
        {
            include_once WCEAZY_PRO_PATH . "frontend/api/address_book/get_address_on_checkout.php";
            wp_die();
        }
        ...
        public function wceazy_pre_order_search() {
            include_once WCEAZY_PRO_PATH . "frontend/api/pre_order/search.php";
            wp_die();
        }
        
        public function wceazy_pre_order_add_to_cart() {
            include_once WCEAZY_PRO_PATH . "frontend/api/pre_order/add_to_cart.php";
            wp_die();
        }
        ...
        {
            include_once WCEAZY_PRO_PATH . "frontend/api/product_filter/search.php";
            wp_die();
        }
        public function wceazy_product_filter_add_to_cart()
        {
            include_once WCEAZY_PRO_PATH . "frontend/api/product_filter/add_to_cart.php";
            wp_die();
        }
