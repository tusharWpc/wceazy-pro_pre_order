...
if (!class_exists('WcEazyClient')) {
    class WcEazyClient
    {
        ...
        public function __construct()
        {
            if (in_array('woocommerce/woocommerce.php', apply_filters('active_plugins', get_option('active_plugins')))) {
                ...
                if ($this->settings->getModuleStatus("auto_apply_coupon")) {
                    include_once WCEAZY_PRO_PATH . "modules/auto_apply_coupon/class-module-client.php";
                ...
                if ($this->settings->getModuleStatus("bogo_deal")) {
                    include_once WCEAZY_PRO_PATH . "modules/bogo_deal/class-module-client.php";
                ...
                if ($this->settings->getModuleStatus("url_coupon")) {
                    include_once WCEAZY_PRO_PATH . "modules/url_coupon/class-module-client.php";
                ...
                if ($this->settings->getModuleStatus("product_sticky_bar")) {
                    include_once WCEAZY_PRO_PATH . "modules/product_sticky_bar/class-module-client.php";
                ...
                if ($this->settings->getModuleStatus("one_click_checkout")) {
                    include_once WCEAZY_PRO_PATH . "modules/one_click_checkout/class-module-client.php";
                ...
                if ($this->settings->getModuleStatus("floating_cart")) {
                    include_once WCEAZY_PRO_PATH . "modules/floating_cart/class-module-client.php";
                ...
                if ($this->settings->getModuleStatus("pdf_invoice")) {
                    include_once WCEAZY_PRO_PATH . "modules/pdf_invoice/class-module-client.php";
                ...
                if ($this->settings->getModuleStatus("shipping_bar")) {
                    include_once WCEAZY_PRO_PATH . "modules/shipping_bar/class-module-client.php";
                ...
                if ($this->settings->getModuleStatus("pre_order")) {
                    include_once WCEAZY_PRO_PATH . "modules/pre_order/pre-class-module-client.php";
                ...
                if ($this->settings->getModuleStatus("address_book")) {
                    include_once WCEAZY_PRO_PATH . "modules/address_book/class-module-client.php";
                ...
                if ($this->settings->getModuleStatus("product_filter")) {
                    include_once WCEAZY_PRO_PATH . "modules/product_filter/class-module-client.php";
                ...
                if ($this->settings->getModuleStatus("order_cancel")) {
                    include_once WCEAZY_PRO_PATH . "modules/order_cancel/class-module-client.php";
                    include_once WCEAZY_PRO_PATH . "modules/order_cancel/ModuleUtils.php";
                    $this->order_cancel = new WcEazyOrderCancelClient($this);
                }
            }
        ...
        function wceazy_client_enqueue()
        {
            ...
            /* ======== Pre order ========== */
            if ($this->settings->getModuleStatus("pre_order")) {
                wp_enqueue_style('wceazy-client-module-pre-order', WCEAZY_PRO_CSS_DIR . 'pre_order/client_main.css', array(), WCEAZY_PRO_VERSION);

                wp_enqueue_script('wceazy-client-module-pre-order', WCEAZY_PRO_JS_DIR . 'pre_order/client_main.js', array('jquery'), WCEAZY_PRO_VERSION);
                wp_localize_script(
        ...
        {
            include_once WCEAZY_PRO_PATH . "frontend/templates/dashboard.php";
        }
