...
<style>
    #wceazy_frontend_fc_bubble_<?php echo esc_attr($unique_id); ?> {
        ...
        --wceazy_fc_basket_icon: url(<?php echo WCEAZY_PRO_URL; ?>assets/img/modules/floating_cart/basket_<?php echo $wceazy_fc_basket_icon; ?>.svg);
    ...
    #wceazy_frontend_fc_<?php echo esc_attr($unique_id); ?> {
        ...
        --wceazy_fc_item_remove_icon: url(<?php echo WCEAZY_PRO_URL; ?>assets/img/modules/floating_cart/delete_<?php echo $wceazy_fc_item_remove_icon; ?>.svg);
    ...
    .wceazy_fc_bubble {
        <?php if ($wceazy_fc_basket_position == "top_left") { ?>top: 110px;
        bottom: auto;
        right: auto;
        left: 60px;
        <?php } ?><?php if ($wceazy_fc_basket_position == "top_right") { ?>top: 110px;
        bottom: auto;
        right: 60px;
        left: auto;
        <?php } ?><?php if ($wceazy_fc_basket_position == "bottom_left") { ?>top: auto;
        bottom: 110px;
        right: auto;
        left: 60px;
        <?php } ?><?php if ($wceazy_fc_basket_position == "bottom_right") { ?>top: auto;
        bottom: 110px;
        right: 60px;
        left: auto;
        <?php } ?><?php if ($wceazy_fc_basket_position == "top_left") { ?>margin-left: <?php echo $wceazy_fc_basket_offset_vertical; ?>px;
        margin-top: <?php echo $wceazy_fc_basket_offset_horizontal; ?>px;
        <?php } ?><?php if ($wceazy_fc_basket_position == "top_right") { ?>margin-right: <?php echo $wceazy_fc_basket_offset_vertical; ?>px;
        margin-top: <?php echo $wceazy_fc_basket_offset_horizontal; ?>px;
        <?php } ?><?php if ($wceazy_fc_basket_position == "bottom_left") { ?>margin-left: <?php echo $wceazy_fc_basket_offset_vertical; ?>px;
        margin-bottom: <?php echo $wceazy_fc_basket_offset_horizontal; ?>px;
        <?php } ?><?php if ($wceazy_fc_basket_position == "bottom_right") { ?>margin-right: <?php echo $wceazy_fc_basket_offset_vertical; ?>px;
        margin-bottom: <?php echo $wceazy_fc_basket_offset_horizontal; ?>px;
        <?php } ?>
    }

    .wceazy_fc_bubble .wceazy_fc_basket_item_count {
        <?php if ($wceazy_fc_basket_count_position == "top_left") { ?>top: -5px;
        bottom: auto;
        left: -11px;
        right: auto;
        <?php } ?><?php if ($wceazy_fc_basket_count_position == "top_right") { ?>top: -5px;
        bottom: auto;
        left: auto;
        right: -11px;
        <?php } ?><?php if ($wceazy_fc_basket_count_position == "bottom_left") { ?>top: auto;
        bottom: -5px;
        left: -11px;
        right: auto;
        <?php } ?><?php if ($wceazy_fc_basket_count_position == "bottom_right") { ?>top: auto;
        bottom: -5px;
        left: auto;
        right: -11px;
        <?php } ?>
    ...
    <?php if ($wceazy_fc_auto_open_cart == "yes") { ?>.wceazy_fc_main {
        display: flex;
    }

    <?php } ?><?php if ($wceazy_fc_show_header_basket_icon == "no") { ?>.wceazy_fc_header .wceazy_fc_header_title {
        background: none;
        padding: 0;
    }

    <?php } ?><?php if ($wceazy_fc_show_header_close_icon == "no") { ?>.wceazy_fc_header .wceazy_fc_close {
        display: none;
    }

    <?php } ?><?php if ($wceazy_fc_show_product_image == "no") { ?>.wceazy_fc_product_part_1 {
        display: none;
    }

    <?php } ?><?php if ($wceazy_fc_show_product_name == "no") { ?>.wceazy_fc_product_part_2 .wceazy_fc_product_title {
        display: none;
    }

    <?php } ?><?php if ($wceazy_fc_show_product_price == "no") { ?>.wceazy_fc_product_part_2 .wceazy_fc_product_unit_price {
        display: none;
    }

    <?php } ?><?php if ($wceazy_fc_show_product_price_total == "no") { ?>.wceazy_fc_product_part_3 .wceazy_fc_product_total {
        display: none;
    }

    <?php } ?><?php if ($wceazy_fc_delete_item_form_cart == "no") { ?>.wceazy_fc_product_part_3 .wceazy_fc_product_remove {
        display: none;
    }

    <?php } ?><?php if ($wceazy_fc_allowed_quantity_update == "no") { ?>.wceazy_fc_product_part_2 .wceazy_fc_product_quantity {
        display: none;
    }

    <?php } ?><?php if ($wceazy_fc_show_subtotal == "no") { ?>.wceazy_fc_stats .wceazy_fc_stats_subtotal {
        display: none;
    }

    <?php } ?><?php if ($wceazy_fc_show_discount == "no") { ?>.wceazy_fc_stats .wceazy_fc_stats_discount {
        display: none;
    }

    <?php } ?><?php if ($wceazy_fc_show_shipping_amount == "no") { ?>.wceazy_fc_stats .wceazy_fc_stats_shipping {
        display: none;
    }

    <?php } ?><?php if ($wceazy_fc_show_cart_total == "no") { ?>.wceazy_fc_stats .wceazy_fc_stats_total {
        display: none;
    }

    <?php } ?><?php if ($wceazy_fc_show_coupon == "no") { ?>.wceazy_fc_coupon {
        display: none;
    }

    <?php } ?><?php if ($wceazy_fc_basket_show_count == "no") { ?>.wceazy_fc_bubble .wceazy_fc_basket_item_count {
        display: none;
    }
...
<div id="wceazy_frontend_fc_<?php echo esc_attr($unique_id); ?>" class="wceazy_fc_main <?php echo $wceazy_fc_footer_position_fixed == "yes" ? "fixed_footer" : ""; ?> <?php echo esc_attr($wceazy_fc_open_from); ?>">
    ...
    <div class="wceazy_fc_main_container">
        ...
        <div class="wceazy_fc_coupon">
            <p class="wceazy_fc_coupon_title"><?php esc_html_e('Got a discount code?'); ?></p>
            <div class="wceazy_fc_coupon_box">
                <input class="wceazy_fc_coupon_field" type="text" placeholder="Enter Discount Code" />
                <button class="wceazy_fc_coupon_apply_btn" onclick="wceazy_frontend_fc_apply_coupon(this)"><?php esc_html_e( 'Apply', 'wceazy');?></button>
            </div>
        </div>
        ...
        <div class="wceazy_fc_stats">
            <div class="wceazy_fc_stats_subtotal">
                ...
                <p class="wceazy_fc_stats_value bold"><?php esc_html_e('$100', 'wceazy');?></p>
            </div>
            <div class="wceazy_fc_stats_discount">
                <p class="wceazy_fc_stats_title"><?php esc_html_e('Discount', 'wceazy');?></p>
                <p class="wceazy_fc_stats_value"><?php esc_html_e('$0.00', 'wceazy');?></p>
            </div>
            <div class="wceazy_fc_stats_shipping">
                <p class="wceazy_fc_stats_title"><?php esc_html_e('Shipping', 'wceazy');?></p>
                <p class="wceazy_fc_stats_value"><?php esc_html_e('$0.00', 'wceazy');?></p>
            </div>
            <div class="wceazy_fc_stats_total">
                <p class="wceazy_fc_stats_title bold"><?php echo $wceazy_fc_total_amount_text; ?></p>
                <p class="wceazy_fc_stats_value bold"><?php esc_html_e('$100.00', 'wceazy');?></p>
            </div>
        </div>
